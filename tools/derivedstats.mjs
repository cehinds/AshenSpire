...
check('CON HP starts from class data and pays the shared gain per five-point tier', () => {
  const out = deriveStat(resolved(), 'hp', { attributes: { constitution: 10 }, classDef: CLASS });
  equal(out.base, 84, 'class HP base'); equal(out.value, 86, 'derived HP: 84 + two shared tiers of one');
});
