...
async function browserRoute(entries, {
  ...
  try {
    ...
    await until('!!document.querySelector(".settings-modal .set-tab[data-member=\\"Changelog\\"]")', 'Changelog category is unreachable');
    await evaluate('document.querySelector(".settings-modal .set-tab[data-member=\\"Changelog\\"]").click()');
    await until('!!document.querySelector(".settings-modal .about-changelog details.about-change summary")', 'Changelog category did not mount the changelog');
...
async function selftest() {
  ...
  const treePlants = [
    ...
    {
      name: 'missing Changelog category mount', file: 'src/ui/screens/settings.js',
      find: "Changelog: { mount: 'set-changelog-mount'", replace: "Changelog: { mount: 'set-changelog-missing'", expect: 'Changelog category did not mount the changelog',
    },
    {
    ...
    },
    {
      ...
      find: '<summary class="region-fold">', replace: '<div class="region-fold">', expect: 'Changelog category did not mount the changelog',
    },
    {
