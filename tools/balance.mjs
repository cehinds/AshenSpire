...
P('');
P('> Note: the Rot Valkyrie (final boss) also heals **3 per hit she lands** via a');
...
P('  needs a built deck (Vagabond ~36%, Prophet ~8%, Astrologer ~1% with a');
P('  combo-blind bot) — exactly the "build across the act" curve. Astrologer\'s');
P('  low floor reflects its fragile-early identity plus the bot\'s inability to');
P('  sequence Glintstone combos, not a content problem.');
P('- The **Rot Valkyrie** is the tightest DPS check (280 HP + up to ~15 heal/turn');
