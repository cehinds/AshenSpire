...
| authorize-scheduler-cutover | owner | yes | yes | `target`, `expected_current_hash`, `candidate_oid`, `scheduler_cutover` | one fail-closed activation of the exact reviewed scheduler v2 descendant after exact migration, Project-schema, quiet-window, released-custody and zero-work-lease evidence |
