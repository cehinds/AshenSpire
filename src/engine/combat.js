 ...
 *
 * Registries, RNG, and runtime methods are dependencies and are reattached by
 * restoreCombatSnapshot. A live queue or event buffer means dispatch has not
 * committed yet, so saving there is refused instead of recording a torn turn.
 */
