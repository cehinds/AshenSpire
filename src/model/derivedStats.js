...
// Ruleset 7 (plan A3) retunes the Actions and HP rows for the lean scale.
// Ruleset 8 (plan A4) is ruleset 7 with the Draw row's base at 5; it is a
// version of its own so a run born under 7 or earlier keeps drawing what it drew.
export const DERIVED_STAT_RULESET_VERSIONS = Object.freeze([1, 2, 3, 4, 5, 6, 7, 8]);
