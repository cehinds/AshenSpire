...
const ROWS = [
  ...
  // cinders, and leave when you choose. Default ON: the owner's uploaded
  // configuration (#1254, 2026-09-23) settled the earlier 'maybe'.
  ...
  // Default ON: the owner's uploaded configuration (#1254, 2026-09-23).
  ...
  // SHORT-SCREEN WARNING, DEFAULT OFF (owner's uploaded configuration, #1254,
  // 2026-09-23): the one-token flip the 2026-08-17 ruling held for him. Off
  // draws the board on a short screen anyway; on a sideways phone END TURN then
  // sits off screen with no scroll path to it (`node tools/uprightgate.mjs`),
  // which the row's note says. Landscape support proper is still owed.
