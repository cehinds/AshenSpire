...
export const relics = [
...

  {
    ...
    rarity: 'starter',
    passives: {
      // A2 Starseer starvation: Mana 1 -> 3 and Max HP +14 (34 -> 48; 38 -> 52 under
      // A3's ruleset 7. Re-measured on A3 at 120 runs: +14 keeps the Starseer at 47/120,
      // +10 drops it to 37/120, below the 35-65% band, so +14 stays).
