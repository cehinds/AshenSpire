...
export const GENERATED_CHANGELOG = Object.freeze([
  {
    ...
    "date": "2026-09-24",
    "group": "2026-09-24",
    "summary": "New games start with your own settings: manual rewards, multi-use Shrines, flasks on the map, a longer title pause and no short-screen warning",
    "detail": "These are the defaults from the configuration file you uploaded. Rewards after a fight now wait for you to take them; a distracted Continue leaves what you did not pick, and Reward collection in Settings still offers automatic collection. A Shrine stays open after you Rest or Smith, so you can Level too and leave when you choose. Crimson and Azure Flasks can be drunk from the map, and their charges still refill only at a Shrine. The title screen holds for 2 seconds instead of half a second. On a screen too short for the board, such as a phone turned sideways, the game now draws the board instead of asking you to turn the phone back; End Turn can then sit off screen, and Short-screen warning in Settings turns the warning back on. Anything you had already set keeps your choice; only settings you never touched take the new defaults.",
    "build": "0.7.1.443",
    "pullRequest": 1254,
