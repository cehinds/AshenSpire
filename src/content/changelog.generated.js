...
export const GENERATED_CHANGELOG = Object.freeze([
  {
    ...
    "detail": "Nothing you play changes. The new prologue path scenes for the Crownfall, the Marches, the Reach and the Weald arrived without their smaller phone copies, so the phone edition refused to build at all; the eight copies are now made the same way as every other piece of phone art. They take the phone edition's art a little past its old 40 MB share, so that share is now 41 MB; the phone edition as a whole is still held under the owner's 50 MB cap.",
    "build": "0.7.1.457",
    "pullRequest": 1290,
