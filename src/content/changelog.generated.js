...
export const GENERATED_CHANGELOG = Object.freeze([
  {
    ...
    "detail": "Nothing a player sees changes. Several changes had landed without an entry here, and writing them turned out to be a moving target: while this was being prepared, other work landed that filled in two of them, so those were dropped rather than written twice, and two newer gaps took their place. Each entry's build number is read out of the project's own history at the moment that change landed, never copied from what its author wrote down; on the one occasion the two disagreed, the history was right.",
    "build": "0.6.0.134",
    "pullRequest": 954,
  ...
  },
  {
    ...
    "detail": "Looking at a location on the world map and then travelling there used to be able to show you two different scenes. Both now resolve the same spot to the same setting and pick from the same pool of paintings, and the choice is remembered once you enter, so it stays put from turn to turn. Where a time-of-day or weather variant does not exist, it falls back within the same setting rather than to something unrelated. Travel is green and sits bottom-right, and the local map controls follow the direction they move you.",
    "build": "0.6.0.122",
    "pullRequest": 928,
