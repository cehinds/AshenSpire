...
export const GENERATED_CHANGELOG = Object.freeze([
  {
    ...
    "detail": "Nothing you see changes yet. A generated list now names each of the game's 5,201 art files with the lighter file development builds carry and the full-resolution original, with their sizes and fingerprints, and the game can take a full-resolution source over its built-in art for any file that source has — the groundwork for an Art quality setting.",
    "build": "0.7.1.561",
    "pullRequest": 1338,
