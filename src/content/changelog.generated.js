...
export const GENERATED_CHANGELOG = Object.freeze([
  ...
  },
  {
    ...
    "detail": "Combat cards retain a 5:7 profile across screen widths, character preview cards keep a 3:4 silhouette, and Armoury sprites fit both available dimensions without stretching. Card artwork stays contained and the fan reserves clearance for larger text. Pile viewers use larger cards with readable text and spaced rows on phones; combatant scaling is bounded by available space rather than an extra zoom cap.",
    "build": "0.5.5.87",
    "pullRequest": 741,
