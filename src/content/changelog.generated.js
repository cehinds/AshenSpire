...
export const GENERATED_CHANGELOG = Object.freeze([
  {
    ...
    "detail": "Nothing you see changes. The prologue journey-scene entry moves up one line so each date's entries read newest build first, #1305 and #1307, which landed without entries, get their receipts below, and the scene editor's new resize handle is placed in the game's zoomed layout space, so it sits on the traveller at every text size. Its two Crownfall phone images are regenerated by the mobile-art tool, which sizes them one pixel differently from the hand-compressed copies.",
    "build": "0.7.1.473",
    "pullRequest": 1303,
