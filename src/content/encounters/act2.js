...
export const act2Encounters = [
  ...
  {"id":"a2_mirrorArchive","enemies":["mirrorScribe"],"weight":15,"pool":"normal","act":2,"floorBand":{"min":1,"max":4},"targetBand":{"min":7,"max":10}},
  {"id":"a2_stitchDrain","enemies":["stitchCrab"],"weight":15,"pool":"normal","act":2,"floorBand":{"min":2,"max":4},"targetBand":{"min":7,"max":10}},
  {"id":"a2_bossGlassRegent","enemies":["glassRegent"],"weight":1,"pool":"boss","act":2,"floorBand":{"min":6,"max":6},"targetBand":{"min":11,"max":12}},
  {"id":"a2_bossMarrowOrganist","enemies":["marrowOrganist"],"weight":1,"pool":"boss","act":2,"floorBand":{"min":6,"max":6},"targetBand":{"min":11,"max":12}},
];
