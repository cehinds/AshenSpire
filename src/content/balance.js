...
export const balance = {
  ...
  ui: {
    ...
    //
    // `manual` is the default: the owner's uploaded configuration (#1254,
    // 2026-09-23). The cost, stated: under manual a distracted Continue walks
    // away from rewards not taken; `auto` (a stored preference) banks them, and
    // an explicit SKIP on a row is respected either way.
    rewardCollect: {
      def: 'manual',
      modes: ['auto', 'manual'],
    },
