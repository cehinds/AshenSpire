...
let zoomExtra = 0;
{
  ...
  const { fileURLToPath } = await import('node:url');
  const files = ['wireframe-card.test.mjs', 'wireframe-hand.test.mjs', 'wireframe-combatant-inspector.test.mjs', 'combat-formation.test.mjs', 'combat-sprite-scale.test.mjs'];
