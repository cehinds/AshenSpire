...
an Armaments summary, Right Hand, Left Hand, then any additional authored socket
such as Armour. The summary reports the currently equipped names and bonuses;
each socket row carries the same item, bonus, and weight fields. The renderer
...
and the supporting trays folded.
...
┌────────────────────────────────────┬──────────────────────────┐
│ ARMAMENTS                          │ INVENTORY                │
│ [Armaments summary]                │ [Wayfarer Plate]         │
