# AshenSpire — Lore Bible

The one-line premise, expanded into a world the game's existing content already
points at. Everything here is consistent with `docs/GDD.md` §4, the enemy roster,
the event pool, the relic list, the four classes, the three biome maps in
...
Golden Sprout, Goldleaf Charm) and on the Goldbough Avatar, a heraldic idol
grown over by a sapling planted as the crest. There was never a great tree.
There was a coat of arms, and a kingdom that believed in it.

Each flame had an order: **Wardens** in the Bastion, **Knights** in the Citadel,
**Saints** in the Observatory's Furnace Chapel. Each order kept a horn, a bell
...
Then the kingdom grew larger than its dead. Three cities, three flames, one
Ember, and the Ember dimming. So the Saints began writing the living. The
**flame-mark** — a brand at birth, a citizen's right to the warmth — was a
promise: *this name, when it is time.* Everyone in the three cities was
promised. Everyone outside the walls was not. That is all a Forsaken is: a
name nobody promised to the fire.

The Burning was the fire calling in the promise. One winter the Ember dimmed
past what the written dead could feed, and it took what it had been promised —
every marked name, all at once, from the inside. The light collapsed *inward*:
the flames did not spread out over the cities, they drew in, and the cities
burned toward their towers. The **Blight** is that collection still going on,
slowly, in whoever did not finish burning. A cinder in a corrupted thing's
chest is a name the fire has not quite finished reading.

The three tellings the player meets on the road are all this event, seen from
three towers:

- **The Warden's telling.** The Crown Flame was fed too much. The Saints,
  wanting the dead to never be forgotten, burned names in the Chapel until the
  Ember could not hold the heat. *(True: the Saints fed it. False: it was too
  much. It was never enough.)*
- **The Court's telling.** The Wardens let the Blight in. Rot in the weald,
  ignored for a season, until it reached the Bastion's bell. *(True: the weald
...
## 3. Cinders, the Corrupted, and what "relight" means

When the flames went out the heat did not vanish. It went into whatever was
closest and would hold it: the marked. That is the Blight — not a plague, but
ember without a hearth, burning inside things that were promised to it.
...
- The river court did not want to die, so it had its surgeons stitch it back
  ...
  to be empty.
- The Saints of the Furnace Chapel kept feeding the Crown Flame long after the
  city was gone. The **Furnace Saint** is the one who never stopped.

A **cinder** is the flame's heat in a form that can be carried. Every corrupted
thing you cut down leaves one, and cinders are the only currency in the Spire
...
went into the Bell Keeper, the Thorn Matriarch, the Fell Warden and every
blight-hound between. The act boss holds the largest cinder in the city; killing
...
The classes are not professions. They are four different relationships with the
fire.
...
not stop; it goes wrong. Briar Hermits root themselves in the outer wards to
stay out of the wind. Lantern Moths carry sparks of ember dust up the walls
looking for a hearth. The Goldbough Avatar kneels in a clearing, grown into the
roots of the crest's sapling, holding out a hand — it does not know the kingdom
is gone. The weald went first, because the Field Flame was the weakest and the
farthest from the Ember.

The Bastion stands on its ridge above the valley, stepped walls and a bell.

- **The Fell Warden** kept the Fell Courtyard gate. He still does. He fights
  with a cane because his leg went the way of the weald.
- **The Bell Keeper** rang the Bellfoundry every dawn so the fields knew the
  hour. The bell is cracked and the dawn does not come, and he rings it anyway.
- **The Thorn Matriarch** was the Wardens' last planting: a warden grafted to
  briar to hold the Briar Sanctum after the order failed. She held.
...
oxidized metal, surgical joins, verdigris, and rime on all of it. The river
city froze the night the Court Flame went out and has not thawed. When it went
out every oath in the kingdom came due at once, and the Court answered the only
way it could: it had its surgeons stitch every knight, hound and courtier back
to their post. Order, kept by force, past the point of meaning anything.

The Citadel stands on its island in the frozen river, bridges and the tower.

- **The Stitched King** has a thousand hands because everyone who swore to him
  is still sewn to the Stitched Throne. His Courtly Decree was the last law of
  the kingdom: every unmarked soul inside the walls, marked by dawn.
- **The Glass Regent** ruled in the Hall of Mirrors while the King was
  "indisposed." The hall is the frozen river under the bridges. She is made of
  the court's reflection in it, and she shatters the same way.
- **The Marrow Organist** plays the Ossuary Organ Hall under the ice. The pipes
...
concentrated ember. The reach did not burn in the Burning: it was already
burning, and the Ember was mined here before it was worshipped. Here the
starving ember pools, and here the things it is pooling *toward* wait. Ash
Revenants reform because the Crown Flame's job was memory, and it is still
...
| Pool | Voice | Where it comes from | Sound |
|---|---|---|---|
| Reaver | **The Warden's field-book** | drill notes, gate logs, the Bastion's bell-roll | terse, second person, imperative |
| Rogue | **The frozen docks** | thieves' cant, surgeons' receipts, things overheard under the bridges | dry, sideways, never a full name |
| Starseer | **The Astronomer's charts** | margins of star tables, eclipse notes, the one thing he did write down | precise, cold, past tense |
| Herald | **The Chapel liturgy** | the funeral rite, the writing of names, the promise at birth | liturgical, first person plural, terrible |
| Colorless / co-op | **The Forsaken** | cairn-scratch, road-marks, what climbers leave for climbers | plain, present tense, no ceremony |

### Seed lines

Reaver (the Warden's field-book):

| Card | Flavor |
|---|---|
| Enter: Gorefire | Hold the flame in the blade, not the hand. It takes the hand. |
| Enter: Bulwark | The gate is a wall you carry. |
| Rallying Standard | The bell rang. The line held. Log it. |
| War Surgeon | Stitch it standing. Sit down and you stay down. |
| Iron Vow | Sworn to the Bastion. Never marked by it. |
| Blood Tithe | What the field takes, it takes in blood, not names. |
| Last Stand | The Fell Courtyard: one gate, one man. Still one man. |
| Executioner | The Warden's cane was a blade once. So was the Warden. |

Rogue (the frozen docks):

| Card | Flavor |
|---|---|
| Pilfer | The Court marked everyone but the pickpockets. Nobody caught them. |
| Vanish | Ice under the bridges. Nothing there. Never was. |
| Garrote | Courtiers' thread. The surgeons never asked what it was for. |
| Venomcoat | Sedative, the surgeon called it. Sold by the vial. |
| Perfect Heist | The Regent's mirrors. Every one accounted for, every one gone. |
| Sap | Marionette strings cut, the dancer keeps dancing a while. |
| Misdirect | The Decree said by dawn. Dawn came late that side of the river. |
| Deathblow | Cold work. The river never thaws, so neither do they. |

Starseer (the Astronomer's charts):

| Card | Flavor |
|---|---|
| Starstone Pebble | Fell burning. Went out. All of it does. |
| Comet Fragment | Chart 41: a fall. Chart 42: a hearth. Nothing between. |
| Stargazer | He watched it dim for a hundred years and wrote nothing down. |
| Supernova | A star finishing is the brightest thing it will ever do. |
| Time Dilation | The eclipse lasted one night. It is still that night. |
| Constellation | Three flames, three twigs, one branch. Drawn on the sky first. |
| Astral Insight | What is fed, burns. What is written, feeds. He underlined it once. |
| Astromancer | Left before the eclipse. Took the charts. Not the names. |

Herald (the Chapel liturgy):

| Card | Flavor |
|---|---|
| Litany | We give the name. We keep the warmth. |
| Blood Pact | The mark at birth is a promise. Here is the promise. |
| Life Tithe | What the dead gave freely, the living were asked for. |
| Last Rites | Written, and warm, and gone. |
| Gilded Oath | Three flames on three twigs. We swore to the branch. |
| Sacred Harvest | The Chapel found it beautiful. It built a chapel. |
| Ember Tide | One winter the fire read every name at once. |
| Blightward | The fire started on me and stopped. I do not know why. |

Colorless (the Forsaken), beside the four lines already shipped:

| Card | Flavor |
|---|---|
| Strike | Never marked. Never promised. Never warm. |
...
|---|---|---|
| **Ember** | the living heat of the Sovereign Ember; the thing that flows up the Spire | fire in general, a status effect |
...
[proposal-seat-adventure.md](proposal-seat-adventure.md) Part I §4.
