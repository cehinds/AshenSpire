...
| 16 | Legacy importer of every legacy entity with stable ids — 393 at this commit (196 cards, 41 equipment, 50 statuses, 19 enemies, 4 classes, 55 relics, 7 flasks, 20 locations, 1 UI surface; `importLegacyContent(contentBundle).counts` is the authority, the number here is its reading on 2026-09-01) | LIVE (data) | `importer.js` | — |
