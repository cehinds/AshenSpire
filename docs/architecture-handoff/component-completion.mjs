...
export const componentCompletionDefaults = {
  ...
  groundGrid: { slotsPerSide: 6, columns: 2, rows: 3, depthPercent: 58, rowStepRem: 4.5, paddingRem: 1, slotGapRem: 1.5, centerGapRem: 3, centerGapPercent: 10, backRowOffsetPercent: 5, actorScale: 0.78, showGuides: true },
