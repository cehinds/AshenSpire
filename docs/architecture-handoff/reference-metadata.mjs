...
export function baseReferenceMetadata(entry){
 ...
 result.implementation ||= {renderer:'renderScreenReference',source:['screen-reference-client.js','screen-reference.mjs'],styles:['screen-reference.css']};
