...
styles.push('exit-component.css','combatant-legibility.css');
...
for(const entry of data){entry.implementation.styles.push('exit-component.css','combatant-legibility.css');if(entry.id.startsWith('WC4')||entry.id.startsWith('WGC')||entry.id==='W4a'){entry.implementation.source.push('combatant-legibility.js','combatant-focus.js','combatant-focus.mjs');entry.implementation.styles.push('combatant-legibility.css');}}
