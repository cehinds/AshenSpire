...
- Source branch: `dev`
- Source commit: `8287e6cd67a68246e95b2be502eeaa2509905415`
...
Tracked files: **3063**.
Extensions: `.bat` 1, `.css` 132, `.csv` 13, `.gitattributes` 1, `.gitignore` 2, `.html` 30, `.jpg` 4, `.js` 1220, `.json` 81, `.md` 106, `.mjs` 186, `.nojekyll` 1, `.png` 946, `.py` 4, `.sh` 4, `.svg` 12, `.txt` 142, `.webp` 106, `.woff2` 64, `.yml` 7, `(none)` 1.
