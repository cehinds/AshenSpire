...
- Source branch: `dev`
- Source commit: `e7c4f7cfde285bf27570e51e8dcc58f7aabbffd5`
...
Tracked files: **3093**.
Extensions: `.bat` 1, `.css` 132, `.csv` 13, `.gitattributes` 1, `.gitignore` 2, `.html` 30, `.jpg` 4, `.js` 1220, `.json` 106, `.md` 106, `.mjs` 186, `.nojekyll` 1, `.png` 946, `.py` 4, `.sh` 4, `.svg` 12, `.txt` 147, `.webp` 106, `.woff2` 64, `.yml` 7, `(none)` 1.
