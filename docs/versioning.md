...
(currently `0.5.0-rc.3.<ordinal>`). This document is the decision workflow for the
...
`0.5.0-rc.3`, the stamp reads `BUILD 0.5.0-rc.3.<ordinal> · src <digest>`, the
dist file is `AshenSpire-0.5.0-rc.3.<ordinal>.html`, and older CHANGELOG
