...
- **Quests that remember what you did:** an event choice is written into your run's history, and a later node opens only once that history has earned it. The Grave of the Nameless is the first chain — dig for cinders and the keeper comes to collect, or pay your respects and be thanked with a relic no shop or drop will ever hand over.
