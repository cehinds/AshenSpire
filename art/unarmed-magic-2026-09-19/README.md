...
Serve the repository and open `runtime-check.html` to exercise the actual action resolver and painted stage for all four default classes: nine casting steps, 800ms release, magic buff, physical ordinary attack and return to physical Ready. It reports suppression as a failure if reduced motion or lightweight rendering prevents playback.
