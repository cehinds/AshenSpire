...
Open index.html directly or through a static server. The preview supports appearance and class filters, all poses, shared sequence playback, stepping, scrubbing, speed, editable repeated pose order, reset, backgrounds, anchors and downloadable sequence settings. Labels appear only in the preview and labeled sheets. overview.webp compares Ready and the main punch across every appearance.
