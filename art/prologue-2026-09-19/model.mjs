...
export function validateSequence(value, defaults) {
  ...
  result.presentation.transitionSeconds=number(p.transitionSeconds,'Transition',0,5);result.presentation.speed=number(p.speed,'Speed',.25,3);result.presentation.wash=number(p.wash,'Colour wash',0,.4);
